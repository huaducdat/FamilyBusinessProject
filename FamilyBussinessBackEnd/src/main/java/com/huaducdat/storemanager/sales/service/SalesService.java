package com.huaducdat.storemanager.sales.service;
...
import com.huaducdat.storemanager.sales.dto.response.InvoiceDetailResponse;
import com.huaducdat.storemanager.sales.dto.response.InvoiceItemResponse;
...
public class SalesService {
    ...
    public InvoiceDetailResponse detail(
        ...
        // TODO: future full tenant isolation; this is a lightweight store guard for read access.
        List<InvoiceItemResponse> items =
                itemRepository
                        .findByInvoiceIdAndInvoiceStoreId(
                                invoiceId,
                                currentUser.getStore()
                                        .getId()
                        )
