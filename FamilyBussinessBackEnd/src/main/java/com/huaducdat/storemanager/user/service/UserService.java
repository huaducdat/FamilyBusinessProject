package com.huaducdat.storemanager.user.service;
...
import com.huaducdat.storemanager.user.dto.request.UpdateUserRequest;
import com.huaducdat.storemanager.user.dto.response.UserResponse;
    ...
    public User create(
        ...
        boolean existed =
                userRepository
                        ...
                        || ownerRepository.existsByUsername(
                                request.getUsername()
                        );
